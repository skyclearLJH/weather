        ...
        {data.map((item) => {
          ...
          return (
            <li key={`${item.rank}-${item.name}-${item.record}`} className={isTopThree ? 'bg-blue-50/30' : ''}>
              ...
              <div className="hidden grid-cols-[88px_minmax(0,0.9fr)_120px_minmax(0,2.6fr)] items-center gap-6 px-6 py-4 md:grid">
                ...
                <div className="pr-2 text-right font-extrabold text-slate-900">{item.record}</div>
